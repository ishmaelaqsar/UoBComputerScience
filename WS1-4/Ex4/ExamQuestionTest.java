...
public class ExamQuestionTest {
	...
	public void setup() {
		...
		ArrayList<String> simpleChoiceAnswers3 = new ArrayList<String>(
				Arrays.asList("Melbourne", "Canberra", "Sydney", "Adelaide"));
		simpleChoiceQuestion3 = new ExamQuestionSimpleChoice("Which is the capital of Australia ?", 100,
				simpleChoiceAnswers3, 2);
		...
		multipleChoiceQuestion2 = new ExamQuestionMultipleChoice("x*x*x-3*x*x+2*x = 0", 10, possibleAnswers2,
				correctAnswers2);
	}
