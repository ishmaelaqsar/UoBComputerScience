...
public class ListOps extends List {
    ...
    /**
     * Return the last element of list a.  Assume that theres is an
     * element.
     */
...
/**
 *  addToEnd can also be defined using append without any further
 recursion.
 public static List<Integer> addToEnd(List<Integer> a, int x) {
 ...
 */
    ...
    /* reverseAccumulate reverses the elements of the list 'original' and
    adds
    *  them at the front of the list 'reversed', returning the resulting
    list.
    */
    private static List<Integer> reverseAccumulate(List<Integer> original,
                                                   List<Integer> reversed) {
        if (original.isEmpty()) {
            return reversed;
        } else {
            return reverseAccumulate(original.getTail(),
                    new List(original.getHead(),
                            reversed));
        }
    }
